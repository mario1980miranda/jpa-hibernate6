...
INSERT INTO tb_client (id, name, cpf) VALUES (1,'Mario Miranda', '12345678901');
INSERT INTO tb_client (id, name, cpf) VALUES (2,'Christina Chan', '11111111111');
INSERT INTO tb_client (id, name, cpf) VALUES (3, 'Gatusca & Nino', '22222222222');

INSERT INTO tb_order(`id`,`client_id`,`total`,`create_date`,`city`,`postal_code`,`province`,`rue`,`status`)VALUES(1,1,1000,sysdate(),'Quebec','G1H2J3','QC','2880, Chemin St-Foy','WAITING');
INSERT INTO tb_order(`id`,`client_id`,`total`,`create_date`,`city`,`postal_code`,`province`,`rue`,`status`)VALUES(2,1,500,sysdate(),'Quebec','G1H2J3','QC','2880, Chemin St-Foy','WAITING');
